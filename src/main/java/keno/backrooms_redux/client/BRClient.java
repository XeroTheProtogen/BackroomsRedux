...
import keno.backrooms_redux.client.renderer.entity.HallucinationEntityRenderer;
...
public class BRClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityRendererRegistry.register(BREntities.HALLUCINATION, HallucinationEntityRenderer::new);
    }
